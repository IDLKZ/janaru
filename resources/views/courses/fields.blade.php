...
<div class="form-group col-sm-6">
    {!! Form::label('category_id', __("admin.category_id")) !!}
    {!! Form::select('category_id', LaravelLocalization::getCurrentLocale() == "ru" ? \App\Models\Category::pluck("title_ru","id")->toArray() :  \App\Models\Category::pluck("title_kz","id")->toArray(),null, ['class' => 'form-control']) !!}
</div>
