...
<head>
    <meta charset="UTF-8">
    <title>Janaru Личный кабинет</title>
            ...
            <li class="nav-item dropdown user-menu">
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <li class="user-footer">
                        <a href="/" class="btn btn-default btn-flat">{{__("admin.main")}}</a>
...
<!-- Content Wrapper. Contains page content -->
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2021 <a href="https://adminlte.io">JANARU</a>.</strong>
    </footer>
</div>
