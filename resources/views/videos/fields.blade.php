...
<div class="form-group col-sm-12">
    ...
    {!! Form::select('course_id', LaravelLocalization::getCurrentLocale() == "ru" ?\App\Models\Course::pluck("title_ru","id")->toArray() :  \App\Models\Course::pluck("title_kz","id")->toArray() ,null, ['class' => 'form-control']) !!}
</div>
